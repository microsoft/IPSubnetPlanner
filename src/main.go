...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(os.Stderr, "    Markdown: generated by default as plan.md (override with -exportmd file.md, disable with -exportmd=\"\").\n")
		fmt.Fprintf(os.Stderr, "    JSON / CSV: disabled by default; enable by supplying a filename (e.g. -exportjson plan.json, -exportcsv plan.csv).\n")
		fmt.Fprintf(os.Stderr, "    Legacy flags (-f, -json, -csv, -md) are still supported for backward compatibility.\n")
		fmt.Fprintf(os.Stderr, "\n")
	}
